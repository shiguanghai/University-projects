package s18001020707.V4.model.People;

import s18001020707.V4.model.Achievement.AchievementObserver;
import s18001020707.V4.model.Achievement.KillEnemys;
import s18001020707.V4.model.Achievement.KillEnemysEvent;
import s18001020707.V4.model.Achievement.Observer;
import s18001020707.V4.model.Command.Invoker;
import s18001020707.V4.model.Command.SkillCommand;
import s18001020707.V4.model.Command.weaponCommand;
import s18001020707.V4.model.Equipment.Clothes.Clothes;
import s18001020707.V4.model.Equipment.Weapon.Weapon;
import s18001020707.V4.model.Equipment.abstractFactory.fresh_factory;
import s18001020707.V4.model.People.Career.Career;
import s18001020707.V4.model.People.ExperienceStrategy.GrowthBehavior;
import s18001020707.V4.model.People.ExperienceStrategy.IntroductionBehavior;
import s18001020707.V4.model.People.ExperienceStrategy.MasterBehavior;
import s18001020707.V4.model.People.ExperienceStrategy.NoviceBehavior;
import s18001020707.V4.model.People.State.Health;
import s18001020707.V4.model.People.State.State;
import s18001020707.V4.model.People.State.binsi;
...
public class Role {
    ...
    public void levelup(){
        ...
        JOptionPane.showMessageDialog(null,"恭喜您升级了！！\n血量上线+"+level*10+","+"魔法值+"+level*10+","+"攻击力+"+level*5+","
                +"防御力+"+level*5+","+"力量+"+level*3+","+"智力+"+level*3+","+"敏捷+"+level*3+"。","提示消息",JOptionPane.WARNING_MESSAGE);
    ...
    public int getMaxExperience(int level){
        ...
        JOptionPane.showMessageDialog(null,"当前等级："+getLevel()+"级,下一级："+getExp()+"/"+RoleCareer.useStage(getLevel()),"提示消息",JOptionPane.WARNING_MESSAGE);
