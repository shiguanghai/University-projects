...
<%--				<li class="navli"><a href="https://github.com/shiguanghai">github</a></li>--%>
...
<%--				<li class="navli"><a target="_blank" href="${APP_PATH }/about">About me</a></li>--%>
			...
			<p>
				Welcome to the blog of <span class="w3-tag">shiguanghai</span>
			</p>
		</header>
			...
			<div class="w3-col l4">
				...
				<div class="w3-card w3-margin w3-margin-top">
					...
					<div class="w3-container w3-white">
						...
						<p> 学习一个新事物，不是学会它的所有用法就能提高，掌握新事物的思想才是突破点。能够搞明白这些新事物为什么这样设计，那就基本上算是出道了。</p>
					</div>
				</div>
				<hr>
				...
				<div class="w3-card w3-margin">
					...
					<ul class="w3-ul w3-hoverable w3-white">
						...
						word-break:break-all;text-overflow:ellipsis;overflow:hidden;"><img src="images/workshop.png"
							alt="Image" class="w3-left w3-margin-right" style="width:50px">
							</li>
						<li class="w3-padding-16" id="li2" style="word-wrap:break-word;
						word-break:break-all;text-overflow:ellipsis;overflow:hidden;"><img src="images/gondol.png"
							alt="Image" class="w3-left w3-margin-right" style="width:50px">
							</li>
						<li class="w3-padding-16" id="li3" style="word-wrap:break-word;
						word-break:break-all;text-overflow:ellipsis;overflow:hidden;"><img src="images/skies.png"
							alt="Image" class="w3-left w3-margin-right" style="width:50px">
							</li>
						...
						word-break:break-all;text-overflow:ellipsis;overflow:hidden;"><img
							src="images/rock.png" alt="Image" class="w3-left w3-margin-right"
							style="width:50px"></li>
					</ul>
				</div>
				<hr>
	...
	<script type="text/javascript">
		...
		function build_blog(result) {
				// 清空分页
					...
					$.each(articles, function(index, item) {
						...
						div1.appendTo("#blog");
						var img = $("<img></img>").attr("src", "images/woods.png").attr("alt", "Nature").css("width","100%");;
						if(index % 5 == 0) {
							img = $("<img></img>").attr("src", "images/woods.png").attr("alt", "Nature").css("width","100%");
						} else if(index % 5 == 1) {
							img = $("<img></img>").attr("src", "images/bridge.png").attr("alt", "Norway").css("width","100%");
						} else if(index % 5 == 2) {
							img = $("<img></img>").attr("src", "images/star8.png").attr("alt", "star8").css("width","100%");
						} else if(index % 5 == 3) {
							img = $("<img></img>").attr("src", "images/starwars.png").attr("alt", "starwars").css("width","100%");
						} else if(index % 5 == 4) {
							img = $("<img></img>").attr("src", "images/starwarsweek.png").attr("alt", "starwarsweek").css("width","100%");
						}
						img.appendTo(div1);
		...
		<label id="pagesinfo"></label> */
			...
			var p1 = $("<p></p>").css("text-align","center").append("@2019 Shiguanghai 豫ICP备19026848号");
			p1.appendTo("#foot"); 
		}
