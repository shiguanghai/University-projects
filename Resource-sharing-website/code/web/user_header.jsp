...
<%--                <li>--%>
<%--                    <a class="nav-link"  id="modal-ziliao" href="#ziliao" role="button" class="btn" data-toggle="modal">资料修改<span class="sr-only">(current)</span></a>--%>
<%--                </li>--%>
                <li>
                    <a class="nav-link" href="user_personal.action">个人空间</a>
                </li>
                <li>
